...
### 🚨 真の P0 次セッション (M-2 本格実装 残 3 方針)

| 順 | ID | 内容 | 工数 |
|---:|---|---|---|
| **1** | **M-2 方針 2** | WF 内部 Isotonic calibration 統合 → WF 再評価 | 3 日 / 1 セッション |
| **2** | **M-2 方針 1** | ML 学習目的の二段化 (head_top3 + head_win) → WF 再評価 | 1 週 / 2-3 セッション |
| **3** | **M-2 方針 3** | ROI 観点 特徴量再選定 (SHAP + permute ROI 寄与度) | 1 週 / 2-3 セッション |
