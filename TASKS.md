...
## 📋 次セッション P0 — M-3 Phase 2 (ROI 期待値 loss 設計)

**マスター基準**: hit% ≥ 25.0% AND ROI ≥ 110.0% (両方同時達成)

**Phase 1 確証**: ML が popularity/odds を一切学習対象にしていない構造課題確定。

**Phase 2 合格ライン**: baseline 74.7% → **+10pt 以上** (= 84.7%+) で Phase 3 へ。

詳細 Plan: `docs/予想精度根本改善Plan.md` / `docs/phase1_feature_diagnosis.md` Section 11

| 順 | Phase | 内容 | 工数 |
|---:|---|---|---|
| ~~1~~ | ~~Phase 1 特徴量診断~~ | ✅ 完了 (5/29) — 改善仮説 H1-H6 抽出済 | ✅ 1 セッション |
| **2** | **Phase 2 学習目的再設計** | H1 ROI 期待値 loss + H2 odds 取込 + WF 再学習 | 2-3 セッション |
