...
import { rankStyle } from "./breakdownStyles";

// rankStyle / diffColor は Fast Refresh 互換のため "./breakdownStyles" に切り出し済。
// 既存 import 互換のため re-export はしない (後方互換性は別ファイル import 経由で維持)。
