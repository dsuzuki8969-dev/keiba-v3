...
/** formation ラベル→日本語説明の凡例マップ (4パターン決定木 2026-06-22) */
const DANSO_FORMATION_LEGEND: Record<string, string> = {
  // 新4パターンラベル
  "1_2tonagashi":   "①2頭流し: 軸突出 + ○▲断層（軸→○→▲△★☆）",
  "2_aitekikkou":   "②相手拮抗: 軸突出 + ▲△断層（軸→○▲→○▲△★☆）",
  "3_nitoukikkou":  "③二頭拮抗: 軸○拮抗（軸○→軸○▲→▲△★☆）",
  "4_ittonagashi":  "④1頭流し: 軸ダントツ（軸→○▲△★☆→○▲△★☆）",
  // 旧ラベル後方互換フォールバック（過去 pred.json 表示用）
