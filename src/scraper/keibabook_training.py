...
NAR_VENUE_TO_KB: Dict[str, Optional[str]] = {
    ...
    "49": "37",  # 園田（新コード） ✓ マスター指摘 2026-04-23: 今年から race_id が 49 になった
    "50": "37",  # 園田（旧コード） ✓ 互換性のため残す
...
# KB調教ページ対応: 門別(30), 浦和(42), 船橋(43), 大井(44), 川崎(45), 園田(49/50), 姫路(51) + JRA全場
# それ以外は調教データ非提供（交流重賞で例外的にある場合があるが通常はなし）
# マスター指摘 2026-04-23: 2026 年から園田の netkeiba コードは "49" に変更。"50" も互換で維持。
